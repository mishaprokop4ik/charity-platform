...
const docTemplate = `{
    ...
    "info": {
        ...
        "contact": {
            ...
            "email": "mykhailo.prokopchyk@nure.ua"
        },
        "license": {
            "name": "Apache 2.0",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/Kurajj_internal_models.EventComplaintsResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/Kurajj_internal_models.ComplaintRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/Kurajj_internal_models.EventBan"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/Kurajj_internal_models.HelpEventCreateRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/Kurajj_internal_models.HelpEventStatistics"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/Kurajj_internal_models.HelpEventTransactionUpdateRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/Kurajj_internal_models.HelpEventRequestUpdate"
                        }
                    },
                    {
                        "type": "integer",
    ...
    "definitions": {
        ...
        "Kurajj_internal_models.ComplaintRequest": {
            "type": "object",
            "properties": {
                "description": {
                    "type": "string"
        ...
        "Kurajj_internal_models.ComplaintResponse": {
            "type": "object",
            "properties": {
                "creationDate": {
                    "type": "string"
        ...
        "Kurajj_internal_models.ComplaintsResponse": {
            "type": "object",
            "properties": {
                "complaints": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/Kurajj_internal_models.ComplaintResponse"
                    }
                },
                "creationDate": {
                    "type": "string"
        ...
        "Kurajj_internal_models.EventBan": {
            "type": "object",
            "properties": {
                "id": {
                    "type": "integer"
        ...
        "Kurajj_internal_models.EventComplaintsResponse": {
            "type": "object",
            "properties": {
                "complaints": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/Kurajj_internal_models.ComplaintsResponse"
                    }
                }
            }
        },
        ...
        "Kurajj_internal_models.HelpEventCreateRequest": {
            ...
            "properties": {
                ...
                "needs": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/Kurajj_internal_models.NeedRequestCreate"
                    }
                },
                "tags": {
                    "type": "array",
        ...
        "Kurajj_internal_models.HelpEventResponse": {
            ...
            "properties": {
                ...
                "transactions": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/Kurajj_internal_models.HelpEventTransactionResponse"
                    }
                }
            }
        },
        "Kurajj_internal_models.HelpEventStatistics": {
            "type": "object",
            "properties": {
        ...
        "Kurajj_internal_models.HelpEventTransactionUpdateRequest": {
            "type": "object",
            "required": [
                "status"
            ],
            "properties": {
                ...
                "needs": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/Kurajj_internal_models.NeedTransactionUpdateRequest"
                    }
                },
                "status": {
                    "$ref": "#/definitions/Kurajj_internal_models.TransactionStatus"
        ...
        "Kurajj_internal_models.NeedRequestCreate": {
            "type": "object",
            "required": [
                "amount",
                "title"
        ...
        "Kurajj_internal_models.NeedResponse": {
            "type": "object",
            "properties": {
                "amount": {
                    "type": "number"
        ...
        "Kurajj_internal_models.NeedTransactionUpdateRequest": {
            "type": "object",
            "properties": {
                "id": {
                    "type": "integer"
